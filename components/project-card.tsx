      ...
      <div className="p-3">
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1">
            <h3 className="text-base font-bold text-white mb-1 line-clamp-1">{project.name}</h3>
        ...
        {viewMode === "swipe" && (
          <div className="flex space-x-3">
            <button
              ...
              className="flex-1 py-3 bg-gray-600 hover:bg-gray-500 text-white font-medium rounded-lg transition-colors flex items-center justify-center text-sm"
            >
            ...
            <button
              ...
              className="flex-1 py-3 bg-[#FFD600] hover:bg-yellow-500 text-black font-medium rounded-lg transition-colors flex items-center justify-center text-sm"
            >
